...
function addTaskToList (item) {
	...
	var taskList = document.getElementById('todolist-toDoTask');
...
function checkTask() {
	...
	var ulID = wantCheck.parentNode.id;
	
	var ul = (ulID === 'todolist-toDoTask') ? document.getElementById('todolist-doneTask'):document.getElementById('todolist-toDoTask');
